...
manhattan(a::Tuple{Int, Int}, b::Tuple{Int, Int}) = sum(abs.(b .- a));

# ╔═╡ e086e39a-5590-48dd-a2de-bc2785532168
function search(heightmap, start, goal)
	neighbour_fn(rc) = neighbours(heightmap, rc)
	astar(neighbour_fn, start, goal; heuristic=manhattan)
end;

# ╔═╡ da9181f4-1a51-4edf-8d9f-a898e9bbc555
# Input data
begin
	testf = "../data/day12-test.txt"
	test_start = (1, 1)
	test_goal = (6, 3)

	inputf = "../data/day12-input.txt"
	input_start = (1, 21)
	input_goal = (138, 21)
end;
